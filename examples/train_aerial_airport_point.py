"""Standalone point finetuning example for maxs-m87/aerial_airport_point_v2.

This example keeps the training loop small, but includes the high-impact knobs
from the stronger airport runs:
...
def main() -> None:
    ...
    parser.add_argument("--finetune-name", default=f"aerial-airport-point-{_random_suffix()}")
    ...
    parser.add_argument("--fp-penalty-exponent", type=float, default=2.0)
    ...
    parser.add_argument("--off-policy-std-thresh", type=float, default=0.01)
    parser.add_argument("--off-policy-max-reward", type=float, default=0.08)
    parser.add_argument("--off-policy-min-reward", type=float, default=0.08)
    parser.add_argument("--off-policy-reward-scale", type=float, default=1.25)
    ...
    parser.add_argument("--wandb-project", default="tuna-aerial-airport-point")
