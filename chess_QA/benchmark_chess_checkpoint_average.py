#!/usr/bin/env python3
"""Benchmark chess checkpoints across multiple splits and emit aggregated metrics."""
...
def parse_args(argv: Optional[list[str]] = None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Benchmark chess checkpoint averages.")
...
def main(argv: Optional[list[str]] = None) -> None:
    ...
    for split_idx, split_name in enumerate(args.avg_splits):
        ...
        split_metrics[split_name] = train_utils._evaluate_split(
            ...
            step_for_log=int(args.checkpoint_step or 0),
